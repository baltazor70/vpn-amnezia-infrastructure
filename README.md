...
Перед отправкой PR:
1. Запустите ./install.sh --check
2. Убедитесь, что изменения не ломают скрипты
...
> 📄 **License:** MIT  
>  **Security:** Не коммитьте .env и секреты в публичные репозитории
